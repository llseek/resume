...
\moveleft\hoffset\vbox{\hrule width\resumewidth height 1pt}
   \vspace{-0.1in}
    ...
    Experienced with programming in Bash and Python\\
    Experienced with CI/CD workflow using Jenkins\\
    Familiar with Linux DRM/IIO/UVC/PM subsystems\\
...
\moveleft\hoffset\vbox{\hrule width\resumewidth height 1pt}
   ...
   {\bf Sony(China) Coporation Co., Ltd} {\hfill 2014.7 - 2016.8\\}
   \emph{Sr. Software Engineer\\}
...
\moveleft\hoffset\vbox{\hrule width\resumewidth height 1pt}
   \vspace{-0.1in}
   {\bf Design and implement CI/CD workflow for testing AMDGPU driver,} {\hfill 2016.11 - present\\}
   \emph {``Jenkins Automation"}\\
