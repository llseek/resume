...
\cvcomputer {户籍地址：}{江苏省苏州市太仓市}{Github：}{github.com/llseek}
\cvline{}{}

\section{IT技能}
\cvline{-}{7年Linux使用和配置经验}
\cvline{-}{熟练掌握C语言程序开发}
...
\cvline{-}{负责基于Zebu/Veloce Emulator的下一代GPU驱动的Bring-up}
\cvline{-}{负责设计与实现针对AMDGPU Graphics Stack的Jenkins自动化测试系统}
\cvline{}{}
...
%\cvline{}{}
%
\cvline{ }{\textcolor{Blue}{基于Zebu/Veloce Emulator的Pre-silicon GPU的Bring-up} \hfill 2018年6月 - 至今}
\cvline{项目简述}{AMDGPU Driver需要在Pre-silicon阶段就开始开发与调试以减少Post-silicon之后的调试时间，从而缩短新一代GPU上市周期}
\cvline{项目职责}{基于现有的驱动框架支持新一代的IP Core}
\cvline{        }{与Emulator团队合作定位并修复潜在Bug}
\cvline{}{}

\cvline{ }{\textcolor{Blue}{针对AMDGPU的Jenkins自动化测试系统的设计与实现} \hfill 2016年12月 - 2018年10月}
\cvline{项目简述}{为了保证AMDGPU Driver的代码质量，需要搭建一套基于Jenkins的自动化编译/打包/部署/测试系统，此项目使用的主要编程语言是Bash/Python/Groovy}
\cvline{项目职责}{从0设计并实现主从模式的部署/测试流程，目前支持30+台目标机，9代不同的GPU}
...
\cvline{项目简述}{Sensor Service作为用户空间的Daemon程序负责为上层应用提供读取Sensor数据的统一的一套API，支持的Sensor包括加速度计/陀螺仪/磁力计/气压计/光传感器/TRAM/GNSS/Geofence}
...
\cvline{ }{\textcolor{Blue}{BMI160 Driver - 6轴传感器驱动的实现和性能优化} \hfill 2014年9月 - 2016年7月}
\cvline{项目简述}{BMI160是一种6轴的加速度/陀螺仪，作为智能眼镜的姿态/运动状态的数据来源，要求其驱动能够实时为上层提供当前采样数据，并支持设置采样频率和水位等参数}
...
\cvline{ }{\textcolor{Blue}{UVC Gadget Driver - 将外设模拟成一个Composite USB设备} \hfill 2015年6月 - 2015年10月}
\cvline{项目简述}{智能眼镜项目需要将外设(眼镜上的Camera)上采集到的图像上传到Host，使用Linux Kernel里已有的UVC Gadget是最初的一种方案}
\cvline{项目职责}{Backport主线Kernel中的ConfigFS特性到公司使用的3.10版本的Kernel}
\cvline{        }{配置Super-speed Buld类型的UVC(默认为Isochronous)}
